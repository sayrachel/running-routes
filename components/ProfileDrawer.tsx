        ...
        {view === 'profile' ? (
          ...
          >
            ...
            <Text style={styles.legalBody}>
              By downloading, installing, accessing, or using the Running Routes mobile application ("App"), you acknowledge that you have read, understood, and agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you must not access or use the App. These Terms constitute a legally binding agreement between you and Running Routes.
            </Text>
            ...
            <Text style={styles.legalBody}>
              Running Routes provides personalized running route generation based on your location, preferences, and publicly available terrain and map data. The App uses GPS tracking and third-party mapping services to suggest routes, record your runs, and display run statistics. Features may change, be updated, or be discontinued at any time without prior notice.
            </Text>
            ...
            <Text style={styles.legalBody}>
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL RUNNING ROUTES, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING WITHOUT LIMITATION PERSONAL INJURY, PAIN AND SUFFERING, EMOTIONAL DISTRESS, LOSS OF DATA, LOSS OF REVENUE, OR LOSS OF PROFITS, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF THE APP. OUR TOTAL AGGREGATE LIABILITY SHALL NOT EXCEED THE AMOUNT YOU HAVE PAID TO US IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM, OR $100 USD, WHICHEVER IS GREATER.
            </Text>

            <Text style={styles.legalHeading}>10. Indemnification</Text>
            <Text style={styles.legalBody}>
              You agree to indemnify, defend, and hold harmless Running Routes and its affiliates, officers, directors, employees, and agents from and against any claims, liabilities, damages, losses, costs, or expenses (including reasonable attorneys' fees) arising out of or related to your use of the App, your violation of these Terms, or your violation of any rights of a third party.
            </Text>
          ...
          >
            ...
            <Text style={styles.legalBody}>
              Running Routes ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use the Running Routes mobile application ("App"). Please read this policy carefully. By using the App, you consent to the practices described in this Privacy Policy.
            </Text>
            ...
            <Text style={styles.legalBody}>
              ...
              {'\u2022'} <Text style={styles.legalBold}>Safety:</Text> To protect the rights, safety, or property of Running Routes, our users, or others{'\n'}
